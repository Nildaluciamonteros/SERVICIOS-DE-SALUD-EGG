...
public class UsuarioServicio implements UserDetailsService {
    ...
    public void registrar(String nombre, String apellido, String telefono,
            String email, ObraSocial obraSocial, String numAfiliado, String password, String password2, MultipartFile archivo) throws MiException {
        if (obraSocial == null) {
            obraSocial = obraSocialServicio.buscarObraSocial("Particular");
        }
        ...
        if (usuario instanceof Paciente) {
            ((Paciente) usuario).setObraSocial(obraSocial);
    ...
    public void actualizar(String idUsuario, String nombre, String apellido,
            String telefono, String email, ObraSocial obraSocial, String numAfiliado, String password, String password2, MultipartFile archivo) throws MiException {
